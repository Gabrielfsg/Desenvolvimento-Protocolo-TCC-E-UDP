...
public class CalculoServidor implements CalculosUteis{
    ...
    public void razaoTempoTransferencia() throws IOException {
        ...
        if(vazoes.size() == 2 && larguras.size() < 2){
            ...
            System.out.println("Razão do Tempo de Transferência (Upload - Servidor): " + (vazaoU / larguraU) + "mb/s");
            System.out.println("Razão do Tempo de Transferência (Download - Servidor): " + (vazaoD / larguraD) + "mb/s");
        }
    }
}
